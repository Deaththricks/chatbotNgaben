...
_916 relations across 466 sentences._
...
| subject | relation | object | source |
|---|---|---|---|
| ngaben _(RITUAL_KEMATIAN)_ | `ADALAH` | ritual kremasi yang berakar pada filosofi pelepasan jiwa ( atma ) dari ikatan duniawi | dependency_rule |
...
| subject | relation | object | source |
|---|---|---|---|
| swasta _(RITUAL_KEMATIAN)_ | `ADALAH` | upacara yang dilakukan jika jenazah tidak ditemukan atau meninggal di perantauan | manual_override |
| swasta _(RITUAL_KEMATIAN)_ | `MENGGUNAKAN` | kayu cendana dan aksara sakral sebagai simbol pengganti jasad | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| nganyut _(TAHAPAN_UPACARA)_ | `BERUPA` | pelarungan abu ke sungai atau laut | manual_override |
| abu _(SARANA_RITUAL)_ | `DIHANYUTKAN_KE` | sungai | manual_override |
| abu _(SARANA_RITUAL)_ | `DIHANYUTKAN_KE` | laut | manual_override |
| nganyut _(TAHAPAN_UPACARA)_ | `MELAMBANGKAN` | pelepasan terakhir menuju moksha _(KONSEP_FILOSOFIS)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| gedarba _(SARANA_RITUAL)_ | `MELAMBANGKAN` | beruang | dependency_rule |
...
| subject | relation | object | source |
|---|---|---|---|
| singa _(SARANA_RITUAL)_ | `ADALAH` | 3:2:2 | dependency_rule |
...
| subject | relation | object | source |
|---|---|---|---|
| kanoroyang sanksi terberat _(KONSEP_HUKUM_ADAT)_ | `BERUPA` | pemberhentian keanggotaan desa adat | dependency_rule |
...
| subject | relation | object | source |
|---|---|---|---|
| bali aga vs bali dataran _(Place)_ | `MEMPEROLEH` | perbedaan mendasar | dependency_rule |
...
| subject | relation | object | source |
|---|---|---|---|
| upakara _(SARANA_RITUAL)_ | `TIDAK_MENJAMIN` | sorga _(KONSEP_FILOSOFIS)_ | manual_override |
| karma wasana _(KONSEP_FILOSOFIS)_ | `MENENTUKAN` | nasib setelah meninggal | manual_override |
...
| layon _(SARANA_RITUAL)_ | `DILETAKKAN_DI` | bale gede _(BANGUNAN_RITUAL)_ | manual_override |
| layon _(SARANA_RITUAL)_ | `DILETAKKAN_DI` | saka roras _(BANGUNAN_RITUAL)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| sekar ura _(SARANA_RITUAL)_ | `MELAMBANGKAN` | perpisahan antara yang meninggal dengan keluarga yang ditinggal | manual_override |
| sekar ura _(SARANA_RITUAL)_ | `MELAMBANGKAN` | harapan selalu diberikan kesejahteraan dan kemakmuran | manual_override |
| sekar ura _(SARANA_RITUAL)_ | `TERDIRI_DARI` | beras kuning | manual_override |
| sekar ura _(SARANA_RITUAL)_ | `TERDIRI_DARI` | wang kepeng/bolong _(SARANA_RITUAL)_ | manual_override |
| sekar ura _(SARANA_RITUAL)_ | `TERDIRI_DARI` | daun temen | manual_override |
| sekar ura _(SARANA_RITUAL)_ | `TERDIRI_DARI` | kembang rampai _(SARANA_RITUAL)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| puspa lingga _(SARANA_RITUAL)_ | `DIAMBIL` | keampigan | dependency_rule |
| ngerorasin _(TAHAPAN_UPACARA)_ | `DIADAKAN_DI` | pura dalem _(BANGUNAN_RITUAL)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| kuburan _(BANGUNAN_RITUAL)_ | `DIAMBIL` | tulang belulang | dependency_rule |
...
| subject | relation | object | source |
|---|---|---|---|
| tegteg _(SARANA_RITUAL)_ | `DIBAWA_KE` | pura dalem _(BANGUNAN_RITUAL)_ | manual_override |
| tegteg _(SARANA_RITUAL)_ | `DIPAKAI_UNTUK` | matur piuning serta memohon atma yang akan diaben | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| ngaben svasta _(RITUAL_KEMATIAN)_ | `ADALAH` | pelaksanaan atiwa-tiwa terhadap orang yang telah meninggal yang jenazahnya tidak mungkin ditemukan kembali | manual_override |
| ngaben svasta _(RITUAL_KEMATIAN)_ | `DITUJUKAN_UNTUK` | jenazah yang telah lama terkubur/terpendam | manual_override |
| ngaben svasta _(RITUAL_KEMATIAN)_ | `DITUJUKAN_UNTUK` | jenazah yang terlalu jauh dari jangkauan kita | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| sawa _(ISTILAH_UMUM_RITUAL)_ | `DIGANTI_DENGAN` | simbol tirtha _(TIRTHA_SUCI)_ | manual_override |
| simbol tirtha | `ADALAH` | toyo çarira | manual_override |
| atiwa-tiwa _(RITUAL_KEMATIAN)_ | `ADALAH` | raçadana | manual_override |
| atiwa-tiwa _(RITUAL_KEMATIAN)_ | `ADALAH` | tirta yadnya pranawa _(RITUAL_KEMATIAN)_ | manual_override |
| raçadana | `SAMA_DENGAN` | atiwa-tiwa asti vedana _(RITUAL_KEMATIAN)_ | manual_override |
| tirta yadnya pranawa | `SAMA_DENGAN` | atiwa-tiwa asti vedana _(RITUAL_KEMATIAN)_ | manual_override |
| atiwa-tiwa _(RITUAL_KEMATIAN)_ | `BAGIAN_DARI` | ngaben svasta _(RITUAL_KEMATIAN)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| banten _(SARANA_RITUAL)_ | `DIKENAL_SEBAGAI` | kala puspa _(SARANA_RITUAL)_ | dependency_rule |
...
| subject | relation | object | source |
|---|---|---|---|
| jenazah _(ISTILAH_UMUM_RITUAL)_ | `DILETAKKAN_DI` | balai posisi kepala berhulu utara | dependency_rule |
...
| soda _(SARANA_RITUAL)_ | `BERUPA` | nasi | manual_override |
| soda _(SARANA_RITUAL)_ | `BERUPA` | minum | manual_override |
| soda _(SARANA_RITUAL)_ | `BERUPA` | buah-buahan | manual_override |
| soda _(SARANA_RITUAL)_ | `BERUPA` | jajan | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| eteh-eteh sawa _(SARANA_RITUAL)_ | `BERUPA` | kain putih untuk saput _(SARANA_RITUAL)_ | manual_override |
| eteh-eteh sawa _(SARANA_RITUAL)_ | `BERUPA` | kamben | manual_override |
| eteh-eteh sawa _(SARANA_RITUAL)_ | `BERUPA` | tapih | manual_override |
| eteh-eteh sawa _(SARANA_RITUAL)_ | `BERUPA` | sabuk | manual_override |
| eteh-eteh sawa _(SARANA_RITUAL)_ | `BERUPA` | udeng _(SARANA_RITUAL)_ | manual_override |
| eteh-eteh sawa _(SARANA_RITUAL)_ | `BERUPA` | pangulungan | manual_override |
| eteh-eteh sawa _(SARANA_RITUAL)_ | `BERUPA` | angkeb rai _(SARANA_RITUAL)_ | manual_override |
| eteh-eteh sawa _(SARANA_RITUAL)_ | `BERUPA` | angkeb baga/purus _(SARANA_RITUAL)_ | manual_override |
| eteh-eteh sawa _(SARANA_RITUAL)_ | `BERUPA` | leluwur _(SARANA_RITUAL)_ | manual_override |
| eteh-eteh sawa _(SARANA_RITUAL)_ | `BERUPA` | tatindih | manual_override |
| eteh-eteh sawa _(SARANA_RITUAL)_ | `BERUPA` | kain putih untuk bantal berisi pis bolong 11 kepeng | manual_override |
| eteh-eteh sawa _(SARANA_RITUAL)_ | `BERUPA` | kain kuning untuk saput atau selendang | manual_override |
| eteh-eteh sawa _(SARANA_RITUAL)_ | `BERUPA` | rantasan kain putih kuning dan kain anyar | manual_override |
| eteh-eteh sawa _(SARANA_RITUAL)_ | `BERUPA` | samsam _(SARANA_RITUAL)_ | manual_override |
| eteh-eteh sawa _(SARANA_RITUAL)_ | `BERUPA` | bunga | manual_override |
| eteh-eteh sawa _(SARANA_RITUAL)_ | `BERUPA` | kwangen _(SARANA_RITUAL)_ | manual_override |
| eteh-eteh sawa _(SARANA_RITUAL)_ | `DIMOHONKAN_DARI` | sulinggih/griya _(ENTITAS_KEAGAMAAN)_ | manual_override |
...
| leluwur _(SARANA_RITUAL)_ | `BERUPA` | kain putih _(SARANA_RITUAL)_ | manual_override |
...
| nanginin _(TAHAPAN_UPACARA)_ | `ADALAH` | membangunkan almarhum seperti membangunkan orang yang sedang tidur | manual_override |
| nanginin _(TAHAPAN_UPACARA)_ | `DISERTAI` | kekidungan yang berhubungan dengan kidung pitra yadnya | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| jenazah _(ISTILAH_UMUM_RITUAL)_ | `MENUJU` | timur | dependency_rule |
| jenazah _(ISTILAH_UMUM_RITUAL)_ | `MENUJU` | utara | dependency_rule |
...
| jenazah _(ISTILAH_UMUM_RITUAL)_ | `DIGULUNG_DENGAN` | kain yang telah dirajah dengan tikar dan kain yang telah dirajah | dependency_rule |
| jenazah _(ISTILAH_UMUM_RITUAL)_ | `DIPASANG` | itik-itik _(SARANA_RITUAL)_ | dependency_rule |
| jenazah _(ISTILAH_UMUM_RITUAL)_ | `DILETAKKAN_DI` | ibu jari kaki | dependency_rule |
| jenazah _(ISTILAH_UMUM_RITUAL)_ | `DILETAKKAN_DI` | ibu jari tangan | dependency_rule |
...
| subject | relation | object | source |
|---|---|---|---|
| sasih yang baik untuk pitra yadnya (khususnya ngaben) _(KONSEP_HUKUM_ADAT)_ | `ADALAH` | kasa _(KONSEP_HUKUM_ADAT)_ | manual_override |
| sasih yang baik untuk pitra yadnya (khususnya ngaben) _(KONSEP_HUKUM_ADAT)_ | `ADALAH` | karo _(KONSEP_HUKUM_ADAT)_ | manual_override |
| sasih yang baik untuk pitra yadnya (khususnya ngaben) _(KONSEP_HUKUM_ADAT)_ | `ADALAH` | katiga _(KONSEP_HUKUM_ADAT)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| sasih kaenem _(KONSEP_HUKUM_ADAT)_ | `DIKENAL_SEBAGAI` | dewasa madya _(KONSEP_HUKUM_ADAT)_ | manual_override |
| sasih kapitu _(KONSEP_HUKUM_ADAT)_ | `DIKENAL_SEBAGAI` | dewasa madya _(KONSEP_HUKUM_ADAT)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| malamasa _(KONSEP_HUKUM_ADAT)_ | `ADALAH` | sasih yang ditampih atau diduakalikan , disebut juga malamasa | dependency_rule |
...
| subject | relation | object | source |
|---|---|---|---|
| puspa asti _(SARANA_RITUAL)_ | `ADALAH` | abu yang diambil dengan mempergunakan sumpit/sepit | manual_override |
| puspa asti _(SARANA_RITUAL)_ | `DIHANCURKAN_DI` | sesenden _(SARANA_RITUAL)_ | manual_override |
...
| dua kata | `ADALAH` | yadnya _(KONSEP_FILOSOFIS)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| pitra yadnya _(RITUAL)_ | `ADALAH` | upacara keagamaan yang diadakan untuk menyelenggarakan atau nyangaskara jenazah atau roh keluarga yang meninggal | manual_override |
| pitra yadnya _(RITUAL)_ | `MENGGUNAKAN` | pelbagai sajen dan alat-alat upakara _(SARANA_RITUAL)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| pitra yadnya _(RITUAL)_ | `TERDIRI_DARI` | beberapa jenis yang pelaksanaannya ber-bhinneka | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| pitra yadnya dataran rendah _(RITUAL)_ | `ADALAH` | hasil penyempurnaan terakhir yang ening sira empu kuturan | manual_override |
| pitra yadnya dataran rendah _(RITUAL)_ | `ADALAH` | hasil penyempurnaan terakhir dang hyang dwijendra | manual_override |
| pitra yadnya dataran rendah _(RITUAL)_ | `ADALAH` | hasil penyempurnaan terakhir empu lutuk | manual_override |
| pitra yadnya dataran rendah _(RITUAL)_ | `ADALAH` | hasil penyempurnaan terakhir dan lain-lain | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| jenazah _(ISTILAH_UMUM_RITUAL)_ | `DIBUNGKUS` | kain putih setelah dimandikan _(SARANA_RITUAL)_ | dependency_rule |
...
| subject | relation | object | source |
|---|---|---|---|
| jenazah momong _(ISTILAH_UMUM_RITUAL)_ | `DISERTAI` | peti samping | dependency_rule |
...
| subject | relation | object | source |
|---|---|---|---|
| jenazah _(ISTILAH_UMUM_RITUAL)_ | `DIMASUKKAN_KE_DALAM` | peti kayu | manual_override |
...
| jenazah bayi _(ISTILAH_UMUM_RITUAL)_ | `DIMANDIKAN` | natar rumah | dependency_rule |
...
| subject | relation | object | source |
|---|---|---|---|
| sawa _(ISTILAH_UMUM_RITUAL)_ | `DIBUNGKUS_DENGAN` | kain putih _(SARANA_RITUAL)_ | manual_override |
| sawa _(ISTILAH_UMUM_RITUAL)_ | `DIIKAT_DENGAN` | benang leleson | manual_override |
| sawa _(ISTILAH_UMUM_RITUAL)_ | `DIIKAT` | sebelas kali | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| tirtha _(TIRTHA_SUCI)_ | `TERBUAT_DARI` | klungah _(SARANA_RITUAL)_ | manual_override |
| pitra yadnya _(RITUAL)_ | `ADALAH` | nglungah _(RITUAL_KEMATIAN)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| sawa anak _(ISTILAH_UMUM_RITUAL)_ | `DIBAKAR` | pitra yadnya nglungah _(RITUAL)_ | dependency_rule |
...
| subject | relation | object | source |
|---|---|---|---|
| tirtha _(TIRTHA_SUCI)_ | `DIPERCIKKAN_PADA_SEBELUM` | tirtha pangentas _(TIRTHA_SUCI)_ | dependency_rule |
...
| subject | relation | object | source |
|---|---|---|---|
| ngaben _(RITUAL_KEMATIAN)_ | `BERTUJUAN_UNTUK` | memusnahkan segenap jasad sawa sehalus-halusnya _(ISTILAH_UMUM_RITUAL)_ | manual_override |
| niskala _(KONSEP_FILOSOFIS)_ | `ADALAH` | batiniah | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| mahabutha _(KONSEP_FILOSOFIS)_ | `DITUJUKAN_UNTUK` | induk asal | dependency_rule |
...
| subject | relation | object | source |
|---|---|---|---|
| jenazah _(ISTILAH_UMUM_RITUAL)_ | `DIMANDIKAN` | balai-balai rumah adat | dependency_rule |
...
| subject | relation | object | source |
|---|---|---|---|
| pepaga _(SARANA_RITUAL)_ | `BERFUNGSI_SEBAGAI` | balai-balai alas memandikan ngringkes | dependency_rule |
...
| subject | relation | object | source |
|---|---|---|---|
| pepaga _(SARANA_RITUAL)_ | `DIPASANG` | secarik kain putih _(SARANA_RITUAL)_ | dependency_rule |
...
| subject | relation | object | source |
|---|---|---|---|
| jenazah _(ISTILAH_UMUM_RITUAL)_ | `BERASAL_DARI` | rumah adat | dependency_rule |
...
| jenazah _(ISTILAH_UMUM_RITUAL)_ | `DIBERI` | sarana simbolik pangringkesan , antara lain sesisir pisang selaku kalang bahu | dependency_rule |
...
| subject | relation | object | source |
|---|---|---|---|
| nyekeh _(RITUAL_KEMATIAN)_ | `BERARTI` | jenazah dibaringkan di rumah adat dalam jangka waktu agak lama hingga tiba hari H untuk ngaben sesuai dewasa yang dipilih | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| nyekeh sawa _(RITUAL_KEMATIAN)_ | `DILAKUKAN_OLEH` | keluarga raja | manual_override |
| nyekeh sawa _(RITUAL_KEMATIAN)_ | `DILAKUKAN_OLEH` | keluarga pendeta | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| damar kurung _(SARANA_RITUAL)_ | `ADALAH` | sarana permohonan kepada sanghyang agni _(ENTITAS_KEAGAMAAN)_ | manual_override |
| damar kurung _(SARANA_RITUAL)_ | `BERTUJUAN_AGAR` | keletehan yang dipancarkan sawa mendiang diblokir terbatas, hanya sebatas tanah pekarangan keluarga mendiang | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| mendiang _(ISTILAH_UMUM_RITUAL)_ | `MEMPEROLEH` | ayaban upakara diuskamaligi yang bermakna penyucian | manual_override |
| ayaban upakara diuskamaligi _(TAHAPAN_UPACARA)_ | `BERTUJUAN_AGAR` | leteh sawa tidak memancar ke luar dan tidak menghimbasi yang lain | manual_override |
...
| patus _(KONSEP_HUKUM_ADAT)_ | `ADALAH` | bantuan gratis | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| ngaben _(RITUAL_KEMATIAN)_ | `ADALAH` | suatu yadnya selaku pelaksanaan ajaran agama | manual_override |
| ngaben _(RITUAL_KEMATIAN)_ | `DIDUKUNG_DENGAN` | sredaning manah atau rasa hati tulus dan ikhlas | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| sawa _(ISTILAH_UMUM_RITUAL)_ | `DITANAM_ATAU_DIBAKAR_SEMENTARA` | status dititip, menunggu biaya untuk menggelar ngaben beberapa bulan atau tahun kemudian | manual_override |
...
| upacara ini | `MEMPERGUNAKAN` | tirtha panglukatan _(TIRTHA_SUCI)_ | manual_override |
| upacara ini | `MEMPERGUNAKAN` | pabersihan _(TAHAPAN_UPACARA)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| tirtha _(TIRTHA_SUCI)_ | `ADALAH` | sarana restu dari ida bhatara di kahyangan tersebut | manual_override |
| tirtha _(TIRTHA_SUCI)_ | `DITUJUKAN_UNTUK` | arwah mendiang dalam peristiwa beralihnya dari dunia manusia ke dunia roh | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| tirtha pangentas _(TIRTHA_SUCI)_ | `BERFUNGSI_UNTUK` | memotong ikatan dan hubungan jasad dengan atma-jiwa dari mendiang | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| tirtha _(TIRTHA_SUCI)_ | `BERPERAN_SEBAGAI` | sarana untuk menetapkan kedudukan arwah mendiang pada satu alam roh (pitra) tertentu | manual_override |
...
| ayaban | `DILAKUKAN_DI` | rumah | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| sawa _(ISTILAH_UMUM_RITUAL)_ | `DIBAKAR` | alat pangringkesan _(TAHAPAN_UPACARA)_ | dependency_rule |
...
| subject | relation | object | source |
|---|---|---|---|
| ngaben _(RITUAL_KEMATIAN)_ | `ADALAH` | malebuang _(RITUAL_KEMATIAN)_ | manual_override |
| ngaben _(RITUAL_KEMATIAN)_ | `ADALAH` | atiwa-tiwa _(RITUAL_KEMATIAN)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| ngaben _(RITUAL_KEMATIAN)_ | `ADALAH` | salah satu yadnya yang paling banyak ragamnya, dari segi variasi besar kecilnya biaya dan wibawa lahiriahnya | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| yadnya _(KONSEP_FILOSOFIS)_ | `BERPERAN_SEBAGAI` | beban | dependency_rule |
...
| subject | relation | object | source |
|---|---|---|---|
| tirtha _(TIRTHA_SUCI)_ | `MEMILIKI` | tarif bak barang dagangan | dependency_rule |
...
| subject | relation | object | source |
|---|---|---|---|
| besar kecil punia atau honorarium _(KONSEP_HUKUM_ADAT)_ | `DISINKRONKAN_DENGAN` | jenis upacara | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| ngaben jenis _(RITUAL_KEMATIAN)_ | `DILAKUKAN_DENGAN` | sawa _(ISTILAH_UMUM_RITUAL)_ | dependency_rule |
...
| subject | relation | object | source |
|---|---|---|---|
| sawa _(ISTILAH_UMUM_RITUAL)_ | `DIBERI` | pakaian selengkap | dependency_rule |
...
| subject | relation | object | source |
|---|---|---|---|
| sawa _(ISTILAH_UMUM_RITUAL)_ | `DIPERCIKKAN_PADA` | tirtha _(TIRTHA_SUCI)_ | dependency_rule |
...
| subject | relation | object | source |
|---|---|---|---|
| beras catur _(SARANA_RITUAL)_ | `ADALAH` | lambang kekuatan panca dewata selaku manifestasi hyang widhi yang mengelola alam semesta (bhuwana agung) | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| abu tulang kepala, tangan, punggung, dada, bokong, paha, dan kaki _(SARANA_RITUAL)_ | `DIGILING` | lumat-lumat | dependency_rule |
...
| subject | relation | object | source |
|---|---|---|---|
| nywasta _(RITUAL_KEMATIAN)_ | `DILAKUKAN_OLEH` | orang | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| nywasta _(RITUAL_KEMATIAN)_ | `ADALAH` | ngaben yang sangat sederhana dalam hal sajen dan alat-alat upakaranya | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| sesajen dan alat upakara _(SARANA_RITUAL)_ | `DISEDIAKAN_DI` | rumah | dependency_rule |
...
| subject | relation | object | source |
|---|---|---|---|
| adegan _(SARANA_RITUAL)_ | `ADALAH` | alat upakara yang terbuat dari daun rontal, beralaskan bakul kecil atau pangkon | manual_override |
...
| jun pere _(SARANA_RITUAL)_ | `BERISI` | air | manual_override |
| jun pere _(SARANA_RITUAL)_ | `BERISI` | 54 atau 108 lembar daun alang-alang | manual_override |
| jun pere _(SARANA_RITUAL)_ | `BERISI` | sembilan batang kayu cendana | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| adegan dan pengawak _(SARANA_RITUAL)_ | `BERADA_DI` | tempat yang telah ditentukan | dependency_rule |
...
| subject | relation | object | source |
|---|---|---|---|
| upakara _(SARANA_RITUAL)_ | `DISUCIKAN_DENGAN` | sajen hingga dianggap wajar untuk digunakan | dependency_rule |
| upakara _(SARANA_RITUAL)_ | `DISUCIKAN_DENGAN` | tirtha panglukatan dengan sajen dan tirtha panglukatan selaku sarana utama nya , hingga dianggap wajar untuk digunakan | dependency_rule |
...
| subject | relation | object | source |
|---|---|---|---|
| sesajen _(SARANA_RITUAL)_ | `MELIPUTI` | diuskamaligi _(TAHAPAN_UPACARA)_ | manual_override |
| sesajen _(SARANA_RITUAL)_ | `MELIPUTI` | nasi angkeb _(SARANA_RITUAL)_ | manual_override |
| sesajen _(SARANA_RITUAL)_ | `MELIPUTI` | saji | manual_override |
| sesajen _(SARANA_RITUAL)_ | `DIPERSEMBAHKAN_KEPADA` | mendiang _(ISTILAH_UMUM_RITUAL)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| tirtha pangentas _(TIRTHA_SUCI)_ | `ADALAH` | siratan terakhir | manual_override |
| tirtha pangentas (dan isinya) _(TIRTHA_SUCI)_ | `DIPERSATUKAN_DENGAN` | isi pengawak _(SARANA_RITUAL)_ | manual_override |
...
| sawa _(ISTILAH_UMUM_RITUAL)_ | `DIBAKAR_DENGAN` | khusuk | manual_override |
| sawa _(ISTILAH_UMUM_RITUAL)_ | `MENJADI` | abu (seluruhnya) _(SARANA_RITUAL)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| abu _(SARANA_RITUAL)_ | `DIMASUKKAN_KE_DALAM` | klungah nyuh gading yang dikasturi dan disukutunggalkan | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| kemampuan sosial ekonomi | `JENIS_DARI` | standar kedudukan seseorang di masyarakat | manual_override |
...
| adegan _(SARANA_RITUAL)_ | `DISISIPI` | awak-awakaning sawa yang terbuat dari sebilah papan cendana atau majagau tipis | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| mendiang _(ISTILAH_UMUM_RITUAL)_ | `DIANGGAP_SEBAGAI` | seseorang yang masih hidup | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| mendiang _(ISTILAH_UMUM_RITUAL)_ | `DITUJUKAN_UNTUK` | hyang prajapati _(ENTITAS_KEAGAMAAN)_ | dependency_rule |
| mendiang _(ISTILAH_UMUM_RITUAL)_ | `DITUJUKAN_UNTUK` | pura dalem _(BANGUNAN_RITUAL)_ | dependency_rule |
| mendiang _(ISTILAH_UMUM_RITUAL)_ | `DITUJUKAN_UNTUK` | sedahan setra _(BANGUNAN_RITUAL)_ | dependency_rule |
...
| pengawak | `DIPERLAKUKAN_SAMA_DENGAN` | sawa asli _(ISTILAH_UMUM_RITUAL)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| sawa _(ISTILAH_UMUM_RITUAL)_ | `MENYEBARKAN` | bau yang kurang sedap | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| sumpe | `BERFUNGSI_SEBAGAI` | penguat rekatan antar badan peti dengan tutupnya | manual_override |
...
| panca datu | `DIPAKAI_UNTUK` | memohon kepada hyang widhi (restu panca dewata) | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| sawa _(ISTILAH_UMUM_RITUAL)_ | `DIKURUNG_DENGAN` | paplengkungan _(BANGUNAN_RITUAL)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| pitara _(KONSEP_FILOSOFIS)_ | `MEWUJUDKAN` | bayangan diri dalam air ening | manual_override |
| tarpana | `DILAKUKAN_DENGAN` | pujastawa | manual_override |
| tarpana | `DILAKUKAN_OLEH` | ida sang sadaka _(ENTITAS_KEAGAMAAN)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| kajang _(SARANA_RITUAL)_ | `BERADA_DI` | plengkungan sawa _(ISTILAH_UMUM_RITUAL)_ | manual_override |
...
| lancingan | `ADALAH` | kain putih (panjangnya puluhan meter) _(SARANA_RITUAL)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| jenazah _(ISTILAH_UMUM_RITUAL)_ | `DIBAWA_KE` | setra tempat pembakaran _(BANGUNAN_RITUAL)_ | manual_override |
| lancingan kajang | `DIJUNJUNG_OLEH` | segenap keturunan mendiang _(ISTILAH_UMUM_RITUAL)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| kajang _(SARANA_RITUAL)_ | `DILETAKKAN_DI` | depan pendeta yang memujanya | manual_override |
...
| kajang _(SARANA_RITUAL)_ | `DIHIDUPKAN_DENGAN` | puja | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| moksa _(KONSEP_FILOSOFIS)_ | `ADALAH` | satu jiwa/atma paratma/brahman _(KONSEP_FILOSOFIS)_ | dependency_rule |
| moksa | `ADALAH` | kembalinya unsur badan manusia ke asalnya (bhuwana agung/pancamahabutha) | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| kajang _(SARANA_RITUAL)_ | `BERPERAN_SEBAGAI` | atribut nilai martabat warga | manual_override |
| kajang _(SARANA_RITUAL)_ | `MEMILIKI` | nilai dan bobot istimewa | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| kajang _(SARANA_RITUAL)_ | `DIPUJA_PADA` | pamlaspasan | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| pelita kecil _(SARANA_RITUAL)_ | `TERBUAT_DARI` | kulit telur ayam berminyak kelapa | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| panguryagan | `BERALASKAN` | tembong (nyiru yang tabingnya tinggi) | manual_override |
| panguryagan | `BERISI` | bermacam-macam ramuan | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| damar kurung _(SARANA_RITUAL)_ | `DINYALAKAN_SAAT` | ngaben jenis sawa wedana (dan angenan turut dinyalakan) | manual_override |
...
| cili | `TERBUAT_DARI` | rontal (dilapisi kertas emas) | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| adegan _(SARANA_RITUAL)_ | `DIAMBIL_OLEH` | keluarga (yang ngaben) | manual_override |
...
| adegan _(SARANA_RITUAL)_ | `DITUJUKAN_UNTUK` | pendeta | dependency_rule |
| adegan _(SARANA_RITUAL)_ | `DIBAWA_MENGHADAP` | pendeta | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| adegan _(SARANA_RITUAL)_ | `ADALAH` | tempat atma mendiang _(ISTILAH_UMUM_RITUAL)_ | manual_override |
...
| upadesa | `BERARTI` | tatwa pengarahan hidup | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| mendiang _(ISTILAH_UMUM_RITUAL)_ | `ADALAH` | pemangku _(ENTITAS_KEAGAMAAN)_ | manual_override |
| mendiang _(ISTILAH_UMUM_RITUAL)_ | `ADALAH` | pejabat | manual_override |
| mendiang _(ISTILAH_UMUM_RITUAL)_ | `ADALAH` | sastrawan | manual_override |
| mendiang _(ISTILAH_UMUM_RITUAL)_ | `MEMILIKI_ALIAS` | ida bagus _(KASTA_SOSIAL)_ | manual_override |
| mendiang _(ISTILAH_UMUM_RITUAL)_ | `MEMILIKI_ALIAS` | ida ayu _(KASTA_SOSIAL)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| adegan _(SARANA_RITUAL)_ | `BERADA_DI` | ruang paturon | dependency_rule |
| adegan _(SARANA_RITUAL)_ | `BERAKHIR_SETELAH` | paguntingan _(TAHAPAN_UPACARA)_ | dependency_rule |
| adegan _(SARANA_RITUAL)_ | `BERAKHIR_SETELAH` | upadesa _(TAHAPAN_UPACARA)_ | dependency_rule |
| sekah kangsen | `DISERTAI_DI` | samping jenazah _(ISTILAH_UMUM_RITUAL)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| mendiang _(ISTILAH_UMUM_RITUAL)_ | `AKRAB_DENGAN` | penghadang | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| mendiang _(ISTILAH_UMUM_RITUAL)_ | `DITERIMA_SEBAGAI` | warga baru dalam pergaulan alam roh | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| sekah abin | `BERPERAN_SEBAGAI` | ciri khusus | manual_override |
| banten bebangkit atau pulagembal _(SARANA_RITUAL)_ | `BERPERAN_SEBAGAI` | dasar | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| sekah abin | `DIPANGKU_OLEH` | yang menggelar yadnya | manual_override |
...
| uang kepeng | `DIBUNGKUS_DENGAN` | daun dapdap _(SARANA_RITUAL)_ | manual_override |
| uang kepeng | `DIIKAT_DENGAN` | benang tridatu (merah, hitam dan putih) | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| pamerasan _(TAHAPAN_UPACARA)_ | `ADALAH` | upacara timbang , antara mendiang yang akan pergi ke dunia lain dengan keluarga ( terutama anak-anak ) yang masih hidup | dependency_rule |
...
| mendiang | `MENYERAHKAN` | hak dan berbagai milik yang dulunya ada pada mendiang | manual_override |
...
| upacara panebusan | `ADALAH` | sesuatu yang mutlak (dalam pengabenan) | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| karma phala orangtua atau leluhur _(KONSEP_FILOSOFIS)_ | `DIWARISKAN_KEPADA` | keturunan (dalam batas tertentu) | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| panebusan _(TAHAPAN_UPACARA)_ | `MEMPENGARUHI` | kedudukan pitara _(ENTITAS_KEAGAMAAN)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| mamutru | `BERASAL_DARI_KATA` | putru | manual_override |
| mamutru | `MERUPAKAN_PERUBAHAN_DARI` | pitra _(KONSEP_FILOSOFIS)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| lontar putru _(NASKAH_SUCI)_ | `MEMILIKI` | jenis | dependency_rule |
| lontar putru | `MEMILIKI_JENIS` | putru sangaskara _(NASKAH_SUCI)_ | manual_override |
| lontar putru | `MEMILIKI_JENIS` | putru saji _(NASKAH_SUCI)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| pabersihan | `DILAKUKAN` | dua atau tiga hari sebelum ngaben | manual_override |
...
| yeh panembak | `DIGUNAKAN_PADA` | pengabenan _(RITUAL_KEMATIAN)_ | manual_override |
...
| pabersihan | `DILANGSUNGKAN_PADA` | hari senin | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| recadana atau swasta geni | `MELENGKAPI` | pangabenan _(RITUAL_KEMATIAN)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| pengabenan _(RITUAL_KEMATIAN)_ | `DINILAI_SEBAGAI` | tingkat utama | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| pering _(SARANA_RITUAL)_ | `MENYERUPAI` | mahkota | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| bade _(SARANA_RITUAL)_ | `ADALAH` | bangunan sawa _(ISTILAH_UMUM_RITUAL)_ | dependency_rule |
...
| subject | relation | object | source |
|---|---|---|---|
| bade jenis _(SARANA_RITUAL)_ | `ADALAH` | bade dalam tata kemasyarakatan pada zaman itu | manual_override |
...
| jenazah raja bali | `ADALAH` | gelgel/klungkung | object_decomposition |
| bade _(SARANA_RITUAL)_ | `MEMILIKI_TINGKAT` | 11 | dependency_rule |
| raja bali | `BERASAL_DARI` | gelgel/klungkung | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| bade _(SARANA_RITUAL)_ | `DITUJUKAN_UNTUK` | keluarga yang leluhurnya pernah menjadi punggawa dan pejabat yang sederajat | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| wadah _(SARANA_RITUAL)_ | `ADALAH` | usungan yang tanpa badawang | manual_override |
| wadah _(SARANA_RITUAL)_ | `MEMAKAI` | hiasan boma dan warna kapas terbatas | manual_override |
...
| mangle _(SARANA_RITUAL)_ | `DIGANTUNGKAN_DI` | masing-masing tingkatan bade atau wadah _(SARANA_RITUAL)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| mangle _(SARANA_RITUAL)_ | `BERGANTUNG_PADA` | tingkatan bade atau wadah _(SARANA_RITUAL)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| mangle _(SARANA_RITUAL)_ | `ADALAH` | pengganti tingkat bade _(SARANA_RITUAL)_ | dependency_rule |
| mangle _(SARANA_RITUAL)_ | `DILETAKKAN_DI` | wadah _(SARANA_RITUAL)_ | manual_override |
...
| jenazah | `DITURUNKAN_DI` | kuburan _(BANGUNAN_RITUAL)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| patulangan _(SARANA_RITUAL)_ | `MENGHASILKAN` | bentuk yang berwujud binatang , yang mempunyai nilai religi tertentu | dependency_rule |
| patulangan | `BERFUNGSI_SEBAGAI` | tempat pembaringan jenazah (dan dapur pembakaran) | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| patulangan _(SARANA_RITUAL)_ | `ADALAH` | pertanda bahwa mereka merupakan keturunan dari orang yang condong pada paksa wesnawa | dependency_rule |
...
> tirtha pangentas dan segala sesuatu syarat agama dijalankan, termasuk "api jatu pembakaran, dengan linting anugrah ida sang sulinggih" tak terkecuali.

| subject | relation | object | source |
|---|---|---|---|
| tirtha pangentas dan segala sesuatu syarat agama _(TIRTHA_SUCI)_ | `BERISI` | api jatu pembakaran | dependency_rule |
| tirtha pangentas dan segala sesuatu syarat agama _(TIRTHA_SUCI)_ | `BERISI` | linting anugrah ida sulinggih _(ENTITAS_KEAGAMAAN)_ | dependency_rule |
...
| subject | relation | object | source |
|---|---|---|---|
| naga banda _(SARANA_RITUAL)_ | `DITUJUKAN_UNTUK` | keluarga tertentu saja | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| mendiang _(ISTILAH_UMUM_RITUAL)_ | `MEMILIKI` | ikatan erat dengan masyarakat | manual_override |
| mendiang | `MEMILIKI` | pertalian intim dengan soal duniawi material | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| kelompok ini | `ADALAH` | paksa mahayana (kendaraan besar) | manual_override |
| kelompok (paksa mahayana) | `BERTUGAS_MENGANGKUT` | masyarakat manusia ke alam sana | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| peranda buddha _(ENTITAS_KEAGAMAAN)_ | `MEMAKAI` | naga banda (pada palebonnya) _(SARANA_RITUAL)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| peranda shiwa _(ENTITAS_KEAGAMAAN)_ | `MENEMPATKAN` | diri/jenana pada daya suci hyang widhi | manual_override |
| peranda shiwa _(ENTITAS_KEAGAMAAN)_ | `MENEMPATKAN_DIRI_DI` | luar alam duniawi (mula-mula di atas) | manual_override |
| peranda shiwa _(ENTITAS_KEAGAMAAN)_ | `TURUN_MERESAPI` | alam ini | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| naga banda _(SARANA_RITUAL)_ | `DIGUNAKAN_SAAT` | palebon | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| naga banda _(SARANA_RITUAL)_ | `DILETAKKAN_DI` | ruang bale semanggen _(BANGUNAN_RITUAL)_ | manual_override |
| naga banda _(SARANA_RITUAL)_ | `BERDAMPINGAN_DENGAN` | jenazah mendiang _(ISTILAH_UMUM_RITUAL)_ | manual_override |
...
| bale salunglung _(BANGUNAN_RITUAL)_ | `DILETAKKAN_DI` | arah hulu | dependency_rule |
| bale salunglung | `DILETAKKAN_DI` | sekitar empat atau lima meter di arah hulu dari tempat pembakaran jenazah | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| bale salunglung _(BANGUNAN_RITUAL)_ | `ADALAH` | bagaikan pitraloka _(KONSEP_FILOSOFIS)_ | manual_override |
| bale salunglung _(BANGUNAN_RITUAL)_ | `ADALAH` | tempat pitra mendiang yang diaben | manual_override |
| bale salunglung _(BANGUNAN_RITUAL)_ | `ADALAH` | wilayah | manual_override |
| wilayah | `ADALAH` | kantongnya segala sesuatu yang didetasering di dunia ini | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| jenazah seseorang (yang telah tertanam-titip) _(ISTILAH_UMUM_RITUAL)_ | `DIBAKAR` | setra lain _(BANGUNAN_RITUAL)_ | manual_override |
| jenazah seseorang | `TERTANAM_TITIP_DI` | sebuah setra _(BANGUNAN_RITUAL)_ | manual_override |
...
| mendiang (keponakan, cucu-cucu) | `TERGOLONG` | keluarga sampingan (bukan keluarga satu sidikara/saling sembah) | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| pamerasan | `ADALAH` | sejumlah uang kepeng _(SARANA_RITUAL)_ | manual_override |
| uang kepeng | `DIBUNGKUS_DENGAN` | daun dapdap _(SARANA_RITUAL)_ | manual_override |
| uang kepeng | `DIIKAT_DENGAN` | benang tridatu | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| pamerasan | `ADALAH` | sarana pemberitahuan akan adanya pangabenan untuk mendiang | manual_override |
| pamerasan | `ADALAH` | tanda bahwa keluarga mendiang tidak lupa akan ikatan keluarga | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| tirtha | `DIMOHON_KEPADA` | pendeta yang muput pangabenan itu sendiri | manual_override |
| sang cucu | `MEMOHON` | tirtha _(TIRTHA_SUCI)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| bale pamuun (dan alat-alat upakara lainnya) | `TELAH_SELESAI_SECARA` | de facto | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| bade dan lembu | `TERGOLONG_BERSAMA` | alat penting lainnya | manual_override |
...
| kajang _(SARANA_RITUAL)_ | `DIBERI` | 30 meter | dependency_rule |
...
| subject | relation | object | source |
|---|---|---|---|
| jenazah /pengawak _(ISTILAH_UMUM_RITUAL)_ | `DILETAKKAN_DI` | balai-balai bade _(SARANA_RITUAL)_ | manual_override |
| kajang _(SARANA_RITUAL)_ | `DILIPAT_DI` | jenazah _(ISTILAH_UMUM_RITUAL)_ | manual_override |
| kajang _(SARANA_RITUAL)_ | `DILIPAT_DI` | simbol | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| adegan | `DIJADIKAN` | unsur arak-arakan indah (oleh pemudi-pemudi keluarga bersangkutan) | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| bale pamuunan | `DIKELILINGI_OLEH` | bade dengan jenazahnya (sebanyak tiga kali) | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| bade _(SARANA_RITUAL)_ | `DILETAKKAN_DI` | teben lembu | dependency_rule |
...
| subject | relation | object | source |
|---|---|---|---|
| pradaksina | `MELAMBANGKAN` | turunnya purusa meresapi pradana (material memperoleh imbas kesucian dari yang immaterial) | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| prasawya _(TAHAPAN_UPACARA)_ | `ADALAH` | lambang gerak peningkatan diri | dependency_rule |
...
| subject | relation | object | source |
|---|---|---|---|
| ngaben _(RITUAL_KEMATIAN)_ | `MEMILIKI` | tujuan pokok | dependency_rule |
...
| cara prasawya | `ADALAH` | berputar | object_decomposition |
...
| subject | relation | object | source |
|---|---|---|---|
| bade | `DILETAKKAN_DI` | sebelah hilir lembu | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| jenazah atau simbolik | `MENJADI` | sasaran segala kegiatan | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| adegan, angenan, pisang jati, panguryagan, dan lain-lain alat yang harus dibakar | `DIPERSEMBAHKAN_KEPADA` | hyang agni (api), tanpa sisa _(KONSEP_FILOSOFIS)_ | manual_override |
| hyang agni | `ADALAH` | api | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| suku tunggal | `MENGHATURKAN` | sembah bakti pamitan kepada bhatara-bhatari _(ENTITAS_KEAGAMAAN)_ | manual_override |
| bhatara-bhatari | `BERSEMAYAM_DI` | pura dan pamrajan panyiwiannya _(BANGUNAN_RITUAL)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| pangabenan | `TERDIRI_DARI` | berbagai jenis | manual_override |
| pangabenan jenis (masing-masing) | `MEMILIKI` | nama sendiri-sendiri | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| pranawa | `BERARTI` | lambang suara "om" | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| mendiang | `MEMPEROLEH` | situasi demikian di alam lain | manual_override |
| supta pranawa | `ADALAH` | satu pangabenan yang berlandaskan hasrat, semoga mendiang mendapatkan situasi demikian di alam lain | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| pangabenan pranawa | `DITUJUKAN_UNTUK` | mendiang yang telah tak ada sawanya lagi | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| sawa wedana | `BERTUJUAN_MENYUCIKAN` | roh | manual_override |
| sawa wedana | `BERTUJUAN_MENYUCIKAN` | arwah | manual_override |
| sawa wedana | `BERTUJUAN_MENYUCIKAN` | badan halus mendiang _(ISTILAH_UMUM_RITUAL)_ | manual_override |
| badan halus mendiang (roh/arwah) | `MENJADI` | atma yang tanpa badan sama sekali | manual_override |
...
| atma wedana | `BERBEDA_DENGAN` | ngaben (dalam hal sifat sebel) _(RITUAL_KEMATIAN)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| pura, pamrajan, atau kahyangan jenis apapun | `ADALAH` | dewaloka _(KONSEP_FILOSOFIS)_ | manual_override |
| pura, pamrajan, atau kahyangan jenis apapun | `ADALAH` | alam kedewaan | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| pitara _(ENTITAS_KEAGAMAAN)_ | `MENGELUPASI` | suksmasarira _(KONSEP_FILOSOFIS)_ | dependency_rule |
...
| subject | relation | object | source |
|---|---|---|---|
| atma wedana _(RITUAL_KEMATIAN)_ | `MEMILIKI` | jenis | dependency_rule |
| jenis atma wedana (masing-masing) | `MEMILIKI` | nama dan ciri-ciri tersendiri | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| tirtha pangentas atiwa-tiwa _(TIRTHA_SUCI)_ | `DIPERCIKKAN_PADA` | sesosok mayat | dependency_rule |
| tirtha pangentas atiwa-tiwa _(TIRTHA_SUCI)_ | `DIPERCIKKAN_PADA` | perlambang | dependency_rule |
...
| subject | relation | object | source |
|---|---|---|---|
| atma wedana _(RITUAL_KEMATIAN)_ | `ADALAH` | upacara penyucian pitra _(KONSEP_FILOSOFIS)_ | dependency_rule |
...
| subject | relation | object | source |
|---|---|---|---|
| bhuwana alit _(KONSEP_FILOSOFIS)_ | `MEMILIKI` | 11 bidang | dependency_rule |
...
| subject | relation | object | source |
|---|---|---|---|
| bhuwana agung (masing-masing arah yang berjumlah 11) | `MEMPEROLEH` | cuntaka selama sehari _(KONSEP_HUKUM_ADAT)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| arjuna | `MENGHUKUM` | diri | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| ngangsen | `ADALAH` | upacara penyucian sementara bagi sang pitra | manual_override |
| pitra (dalam ngangsen) | `BARU_LEPAS_PERTALIAN_DENGAN` | stulasarira nya | manual_override |
| ngangsen | `BERTUJUAN` | agar suksmasarira pitra tidak lagi dilekati bekas-bekas badan kasar | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| pitra _(KONSEP_FILOSOFIS)_ | `DIBUATKAN_UNTUK` | perlambang | dependency_rule |
...
| sekah kangsen _(SARANA_RITUAL)_ | `DISUCIKAN_DENGAN` | sajen kecil dengan tirtha dan sajen kecil sebagai pengantar nya | dependency_rule |
...
| subject | relation | object | source |
|---|---|---|---|
| pitra mendiang | `DIPERSILAKAN_MASUK_KE` | sekah kangsen _(SARANA_RITUAL)_ | manual_override |
| pitra mendiang | `MEMAKAI` | wujud tersebut selaku pralingga (perlambang diri yang dihuni) | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| pitra | `MENERIMA` | sembah bhakti serta ayaban sajen _(TAHAPAN_UPACARA)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| sekah kangsen | `DIBONGKAR_SETELAH` | pamralina | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| abu daun (yang dinilai selaku bekas-bekas stulasarira mendiang) | `DIMASUKKAN_KE_DALAM` | klungah nyuh gading (yang dibentuk menjadi suku tunggal) | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| atma wedana | `DITUJUKAN_UNTUK` | mendiang (baru dapat diadakan setelah mungkin lima atau sepuluh tahun kemudian) | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| payadnyan | `ADALAH` | bangunan pokok pada arena ini | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| payadnyan | `ADALAH` | bangunan yang paling rendah (dari segi ukuran) | manual_override |
| payadnyan | `DIHIAS_PALING` | indah | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| mendiang | `LAHIR_DALAM_WUJUD` | sekah _(SARANA_RITUAL)_ | manual_override |
| mendiang (dalam wujud sekah) | `DIAJAK_BERKOMUNIKASI_OLEH` | keluarga | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| mendiang _(ISTILAH_UMUM_RITUAL)_ | `MENGALAMI` | perubahan wujud | manual_override |
| mendiang _(ISTILAH_UMUM_RITUAL)_ | `BERUBAH_DARI_SUKSMA_SARIRA_MENJADI` | tanpa berbadan sama sekali atau atma tattwatma | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| mendiang _(ISTILAH_UMUM_RITUAL)_ | `MEMPEROLEH` | upanisad _(KONSEP_FILOSOFIS)_ | manual_override |
| upanisad _(KONSEP_FILOSOFIS)_ | `ADALAH` | pawisik | manual_override |
| mendiang _(ISTILAH_UMUM_RITUAL)_ | `MEMPEROLEH_DARI` | pendeta | manual_override |
| upanisad | `TENTANG` | jalan yang harus ditempuh | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| sangge _(SARANA_RITUAL)_ | `ADALAH` | dia | dependency_rule |
...
| subject | relation | object | source |
|---|---|---|---|
| bhatara _(ENTITAS_KEAGAMAAN)_ | `DITUJUKAN_UNTUK` | utpeti _(KONSEP_FILOSOFIS)_ | dependency_rule |
| utpeti _(KONSEP_FILOSOFIS)_ | `ADALAH` | masuk | object_decomposition |
...
| bhatara _(ENTITAS_KEAGAMAAN)_ | `BERPERAN_SEBAGAI` | badan suksma | dependency_rule |
...
| subject | relation | object | source |
|---|---|---|---|
| sanggar surya baligia _(BANGUNAN_RITUAL)_ | `MEMILIKI` | tiga buah ruang | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| sekah | `DITURUNKAN_DARI` | pawedan _(BANGUNAN_RITUAL)_ | manual_override |
| sangge | `JENIS_DARI` | sekah _(SARANA_RITUAL)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| pawedan _(BANGUNAN_RITUAL)_ | `ADALAH` | tempat sang sulinggih dalam memuja _(ENTITAS_KEAGAMAAN)_ | manual_override |
| tempat sang sulinggih dalam memuja | `DIPAKAI_UNTUK` | segenap upacara atma wedana ini _(RITUAL_KEMATIAN)_ | manual_override |
| pawedan | `JUGA_ADALAH` | tempat ngajum serta mengutpeti sekah _(TAHAPAN_UPACARA)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| pawedan (tempat memuja) | `MERUPAKAN` | shiwa (dewa) loka _(ENTITAS_KEAGAMAAN)_ | manual_override |
| shiwa _(ENTITAS_KEAGAMAAN)_ | `ADALAH` | dewa loka _(ENTITAS_KEAGAMAAN)_ | manual_override |
| pawedan (tempat memuja) | `BUKAN_SEKADAR` | "madyapada" | manual_override |
...
| pitra _(KONSEP_FILOSOFIS)_ | `ADALAH` | atma _(KONSEP_FILOSOFIS)_ | object_decomposition |
...
| subject | relation | object | source |
|---|---|---|---|
| payadnyan _(BANGUNAN_RITUAL)_ | `ADALAH` | sekadar bangunan darurat buatan manusia | dependency_rule |
...
| subject | relation | object | source |
|---|---|---|---|
| sekah | `DIMASUKKAN_MELALUI` | pintu belakang | manual_override |
...
| punia (besar-kecilnya) | `SEPADAN_DENGAN` | jenis yadnya dan martabat sang mayadnya | manual_override |
...
| pitra mendiang _(KONSEP_FILOSOFIS)_ | `MENYAKSIKAN` | anak cucu | dependency_rule |
...
| subject | relation | object | source |
|---|---|---|---|
| pitara _(ENTITAS_KEAGAMAAN)_ | `MENGGUNAKAN` | tirtha ening _(TIRTHA_SUCI)_ | manual_override |
| pitara (menggunakan tirtha ening) | `HINGGA_TAMPAK` | bayangan nya | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| manah tirtha ening _(KONSEP_FILOSOFIS)_ | `ADALAH` | pawai yang bernilai seni, lebih-lebih yang untuk pamukuran | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| sulinggih _(ENTITAS_KEAGAMAAN)_ | `MEMBERIKAN` | panjaya-jaya | manual_override |
| sulinggih _(ENTITAS_KEAGAMAAN)_ | `MEMBERIKAN` | ayaban sesayut _(SARANA_RITUAL)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| pralina | `KALAH_MERIAH_DIBANDING` | upacara saji tarpana _(TAHAPAN_UPACARA)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| suksma sarira _(KONSEP_FILOSOFIS)_ | `ADALAH` | materi (walaupun sangat halus) | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| mamukur dan upacara sebangsa _(RITUAL_KEMATIAN)_ | `DILINDUNGI_DENGAN` | upaya penyucian wilayah yang ketat dengan berbagai pantangannya | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| abu _(SARANA_RITUAL)_ | `DIGILING_DI_ATAS` | sesenden _(SARANA_RITUAL)_ | manual_override |
| sesenden _(SARANA_RITUAL)_ | `ADALAH` | dulang tanah _(SARANA_RITUAL)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| abu _(SARANA_RITUAL)_ | `DIMASUKKAN_KE_DALAM` | klungah nyuh gading _(SARANA_RITUAL)_ | dependency_rule |
...
| suku tunggal abu (diarak mapradaksina) | `MELAMBANGKAN` | diresapkannya sinar suci hyang widhi _(KONSEP_FILOSOFIS)_ | manual_override |
| abu | `BERUBAH_DARI` | bekas benda badan linggasarira | manual_override |
| abu | `MENJADI` | mahabutha yang suci | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| atma pitara | `DIMOHONKAN_AGAR_MENUJU` | dewaloka _(KONSEP_FILOSOFIS)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| pitra _(KONSEP_FILOSOFIS)_ | `BAGIAN_DARI` | sekeluarga tunggalan pamrajan _(BANGUNAN_RITUAL)_ | manual_override |
| pitra _(KONSEP_FILOSOFIS)_ | `MENERIMA` | dua buah daksina tapakan (dibuat untuknya) | manual_override |
| daksina tapakan _(SARANA_RITUAL)_ | `DITUJUKAN_UNTUK` | bhatara _(ENTITAS_KEAGAMAAN)_ | manual_override |
| daksina tapakan _(SARANA_RITUAL)_ | `DITUJUKAN_UNTUK` | bhatari _(ENTITAS_KEAGAMAAN)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| pitra | `MENINGKAT_KEDUDUKAN_MENJADI` | bhatara atau bhatari (sejak selesainya patileman) | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| punia | `ADALAH` | perwujudan nyata dari pernyataan parama suksma lahir batin (purusa-pradana) | manual_override |
| punia | `LAHIR_ATAS` | jasa tuntunan yang telah dianugrahkan oleh beliau | manual_override |
| patileman | `DAPAT_SELESAI_SECARA` | tuntas (berkat punia) _(KONSEP_HUKUM_ADAT)_ | manual_override |
...
| perwujudan sredaning cita | `ADALAH` | wujud ketulus-ikhlasan hati pihak | object_decomposition |
...
| pandita (selaku pemuka agama) | `MEMAKLUMI` | ketentuan punia yang demikian itu | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| jenazah | `DIBERSIHKAN_DARI` | kotoran-kotoran (yang telah lama berada pada badan orang yang meninggal) | manual_override |
| jenazah | `DIBERSIHKAN_DARI` | hal-hal yang lain | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| jenazah | `DITUTUP_DENGAN` | kain putih (dari ujung kepala hingga ujung kaki) | manual_override |
| jenazah (ditutup kain putih) | `BERTUJUAN` | agar tidak kelihatan sama sekali | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| punjung _(SARANA_RITUAL)_ | `DITARUHKAN_DI_SAMPING` | jenazah _(ISTILAH_UMUM_RITUAL)_ | manual_override |
| punjung _(SARANA_RITUAL)_ | `BERISI` | nasi dengan lauknya | manual_override |
| punjung _(SARANA_RITUAL)_ | `BERISI` | kopi | manual_override |
| punjung _(SARANA_RITUAL)_ | `BERISI` | rokok | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| atma baan nyilih dan nyawa _(KONSEP_FILOSOFIS)_ | `ADALAH` | pinjaman yang tidak memiliki ketentuan batas, sehingga nyawa itu dapat diambil sewaktu-waktu kapan saja tanpa ada pemberitahuan sebelumnya | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| daun intaran | `DIGUNAKAN_SEBANYAK` | 2 lembar | manual_override |
...
| daun dapdap (yang dihaluskan) | `BERGUNA_SEBAGAI` | sampo pencuci rambut (keramas) bagi jenazah | manual_override |
| daun dapdap | `DIGUNAKAN_SAAT` | upacara nyiramang layon _(TAHAPAN_UPACARA)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| malem _(SARANA_RITUAL)_ | `DIPULUNG` | kelereng | manual_override |
| malem _(SARANA_RITUAL)_ | `DIPULUNG` | minimal dua buah | manual_override |
| malem (setelah dipulung, minimal dua buah) | `DITARUH_DI` | atas takir _(SARANA_RITUAL)_ | manual_override |
| malem (di atas takir) | `DIPAKAI_UNTUK` | ditaruh pada kedua lubang kuping jenazah ketika upacara melelet | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| paes gedubang _(SARANA_RITUAL)_ | `DILETAKKAN_DI` | atas takir _(SARANA_RITUAL)_ | manual_override |
| paes gedubang _(SARANA_RITUAL)_ | `DILETAKKAN_DENGAN` | secarik kain hitam yang digunakan untuk menutup kelamin (angkeb sarira) | manual_override |
...
| lekesan _(SARANA_RITUAL)_ | `DILETAKKAN_DI` | ujung atas | dependency_rule |
...
| kawangen | `DIISI` | 11 kepeng (ditaruh pada setiap persendian/buku-buku) | manual_override |
| kawangen | `DIISI` | 25 kepeng untuk pebaktian jenazah (ditaruh di dada, seolah-olah dipegang oleh tangan jenazah) | manual_override |
...
| kwangen (setiap gulungan) | `DIISI_DENGAN` | uang kepeng _(SARANA_RITUAL)_ | manual_override |
| kwangen | `DIISI_DENGAN` | bawang putih sebagai lambang kuku (di ujungnya) | manual_override |
| kwangen (dengan bawang putih ini) | `DITARUH_DI` | tiap-tiap jari tangan dan kaki jenazah | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| sekar ura | `DITABURKAN_DI` | setiap persimpangan jalan menuju setra _(BANGUNAN_RITUAL)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| sisig _(SARANA_RITUAL)_ | `TERBUAT_DARI` | arang pembakaran jaja gina uli | dependency_rule |
...
| sisig (di atas takir ini) | `DIPAKAI_UNTUK` | gosok gigi jenazah _(ISTILAH_UMUM_RITUAL)_ | manual_override |
...
| pecahan kaca | `DITARUH_DI` | kedua mata (jenazah) _(ISTILAH_UMUM_RITUAL)_ | manual_override |
| pecahan besi baja | `DITARUH_DI` | gigi jenazah _(ISTILAH_UMUM_RITUAL)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| anggapan _(SARANA_RITUAL)_ | `ADALAH` | pisau khusus yang digunakan untuk memotong padi pada masa lalu | manual_override |
| arit gobed _(SARANA_RITUAL)_ | `ADALAH` | sabit kecil untuk memotong rumput | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| anget-angetan | `DISEMBURKAN_PADA` | hulu hati jenazah _(ISTILAH_UMUM_RITUAL)_ | manual_override |
| anget-angetan | `DISEMBURKAN_SAAT` | upacara ngelelet _(TAHAPAN_UPACARA)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| banten pamegat _(SARANA_RITUAL)_ | `DIGUNAKAN_SAAT` | acara maktining layon _(SARANA_RITUAL)_ | manual_override |
| banten pamegat _(SARANA_RITUAL)_ | `DIPAKAI_UNTUK_SEBELUM` | upacara pabresihan mati | manual_override |
| upacara pabresihan mati | `ADALAH` | ngelelet _(TAHAPAN_UPACARA)_ | manual_override |
...
| jenazah | `HARUS_MELALUI` | ujung pepaga/asagan yang di teben (barat) | manual_override |
| jenazah | `DIMASUKKAN` | kepala terlebih dahulu | manual_override |
| kaki jenazah | `BERSELONJOR_KE` | teben/barat | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| jenazah | `NAIK` | bale (dari arah teben menuju luanan/hulu) | manual_override |
...
| keluarga/masyarakat | `DILARANG` | tergesa-gesa memandikan jenazah _(ISTILAH_UMUM_RITUAL)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| krama (masyarakat banjar) | `MEMBUAT` | bale-bale tempat memandikan mayat _(BANGUNAN_RITUAL)_ | manual_override |
| bale-bale (tempat memandikan mayat) | `DIKENAL_SEBAGAI` | pepaga _(SARANA_RITUAL)_ | manual_override |
| bale-bale (tempat memandikan mayat) | `DIKENAL_SEBAGAI` | asagan _(SARANA_RITUAL)_ | manual_override |
...
| pepaga | `DIKENAL_SEBAGAI` | bale penusangan (istilah Denpasar) _(BANGUNAN_RITUAL)_ | manual_override |
| pepaga/asagan | `ADALAH` | semacam dipan atau bale darurat _(BANGUNAN_RITUAL)_ | manual_override |
| pepaga/asagan | `DIPERGUNAKAN_SEBAGAI` | usungan _(SARANA_RITUAL)_ | manual_override |
| pepaga/asagan | `DIPERGUNAKAN_SEBAGAI` | tandu _(SARANA_RITUAL)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| bale _(BANGUNAN_RITUAL)_ | `TERBUAT_DARI` | bambu | manual_override |
| galar _(SARANA_RITUAL)_ | `TERDIRI_DARI` | bilah-bilah bambu (sebanyak 9 buah) | manual_override |
| bale _(BANGUNAN_RITUAL)_ | `TERBUAT_DARI` | galar _(SARANA_RITUAL)_ | manual_override |
...
| jenazah _(ISTILAH_UMUM_RITUAL)_ | `DIAMBIL_DARI` | balai (tempat jenazah disemayamkan) _(ISTILAH_UMUM_RITUAL)_ | manual_override |
| tempat persemayaman jenazah | `DITEMPATKAN_DI` | bale semanggen (rumah adat Bali) _(BANGUNAN_RITUAL)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| jenazah _(ISTILAH_UMUM_RITUAL)_ | `DIUSUNG_KE` | tempat penusangan | manual_override |
| tempat penusangan | `DIPAKAI_UNTUK` | nyiramang layon _(TAHAPAN_UPACARA)_ | manual_override |
| tempat penusangan | `BERUPA` | pepaga atau asagan _(SARANA_RITUAL)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| jenazah _(ISTILAH_UMUM_RITUAL)_ | `NAIK_KE` | pepaga/asagan _(SARANA_RITUAL)_ | manual_override |
| jenazah _(ISTILAH_UMUM_RITUAL)_ | `DIDUDUKKAN_DULU_SEBELUM` | tidur tertelentang di pepaga/asagan _(SARANA_RITUAL)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| jenazah _(ISTILAH_UMUM_RITUAL)_ | `MEMILIKI` | makna agar orang yang meninggal tersebut lebih cepat menemui brahman ( sang pencipta ) | dependency_rule |
...
| kepala jenazah | `DIALASI_DENGAN` | bantal biasa (bantal kapuk) | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| jenazah _(ISTILAH_UMUM_RITUAL)_ | `HARUS_DIBIARKAN` | sebentar (sebelum dibuka pakaiannya) | manual_override |
| orang yang dituakan/lebih tua | `MENCUCI` | muka dan rambut jenazah _(ISTILAH_UMUM_RITUAL)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| jenazah _(ISTILAH_UMUM_RITUAL)_ | `DIBERI` | pakaian seperti layaknya orang masih hidup | manual_override |
...
| jenazah _(ISTILAH_UMUM_RITUAL)_ | `DIHIAS_SEOLAH_OLAH` | pergi menghadiri undangan atau ke pura | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| lekesan _(SARANA_RITUAL)_ | `DITEMPELKAN_DI` | gigi jenazah (ISTILAH_UMUM_RITUAL) _(ISTILAH_UMUM_RITUAL)_ | manual_override |
| jenazah (bibir) | `DIBERSIHKAN_DENGAN` | tembakau (diusapkan pada bibir) | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| kawangen _(SARANA_RITUAL)_ | `MELAMBANGKAN` | tanda doa restu setelah selesai upacara sembah bhakti ini , | dependency_rule |
...
| subject | relation | object | source |
|---|---|---|---|
| tangan jenazah/layon | `DILETAKKAN_DI` | dada | manual_override |
| tangan jenazah/layon | `DITARUH_DENGAN` | posisi telapak tangan ditumpuk (ditumpangkan) | manual_override |
| kawangen _(SARANA_RITUAL)_ | `MELAMBANGKAN` | sikap amusti karana (seolah-olah layon ikut sembahyang) | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| jenazah _(ISTILAH_UMUM_RITUAL)_ | `DIPERCIKI_DAN_DIMINUMKAN` | tirta _(TIRTHA_SUCI)_ | manual_override |
| tirta | `BERASAL_DARI` | bhetara hyang guru _(KONSEP_FILOSOFIS)_ | manual_override |
| tirta | `DIMOHONKAN_DI` | sanggah/pamerajan keluarga orang yang meninggal | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| waja | `BAGIAN_DARI` | panca datu _(SARANA_RITUAL)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| pengerikan kuku mutlak | `DILAKUKAN_SAAT` | upacara "melelet" (pabersihan mati) _(TAHAPAN_UPACARA)_ | manual_override |
| pengerikan kuku | `TIDAK_BOLEH_DILAKUKAN_SAAT` | pabersihan hidup _(TAHAPAN_UPACARA)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| jenazah _(ISTILAH_UMUM_RITUAL)_ | `DIANGGAP_SEBAGAI` | orang yang masih hidup | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| arit gobed _(SARANA_RITUAL)_ | `ADALAH` | simbol rare angon yaitu lambang keperkasaan seorang laki-laki | dependency_rule |
...
| subject | relation | object | source |
|---|---|---|---|
| anggapan _(SARANA_RITUAL)_ | `ADALAH` | simbol dewi sri , yang mana nanti nya diharapkan wanita yang akan " numitis " memiliki kesuburan untuk dapat melahirkan dari dewi sri , yaitu lambang kesuburan | dependency_rule |
...
| subject | relation | object | source |
|---|---|---|---|
| jempol jari tangan (kedua ibu jari) | `DIIKAT_DENGAN` | tali benang tukelan (benang tenun bali) berwarna putih | manual_override |
| jempol jari kaki | `DIIKAT_DENGAN` | tali benang tukelan _(SARANA_RITUAL)_ | manual_override |
...
| jenazah _(ISTILAH_UMUM_RITUAL)_ | `DIBILAS_DENGAN` | air | manual_override |
| jenazah _(ISTILAH_UMUM_RITUAL)_ | `DIKERINGKAN_DENGAN` | kain kering | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| jenazah _(ISTILAH_UMUM_RITUAL)_ | `DIPAKAIKAN` | pakaian putih-putih | manual_override |
| kain bawah | `BERWARNA` | putih | manual_override |
| saput | `BERWARNA` | putih | manual_override |
| umpal | `BERWARNA` | putih | manual_override |
| umpal | `ADALAH` | tali saput _(SARANA_RITUAL)_ | manual_override |
| udeng (untuk laki-laki) _(SARANA_RITUAL)_ | `BERWARNA` | putih | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| bantal kapuk | `DIGANTI_DENGAN` | bantal sesisir buah pisang kayu | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| dewa wishnu _(ENTITAS_KEAGAMAAN)_ | `MENDAPATKAN` | tirtha amertha _(KONSEP_FILOSOFIS)_ | manual_override |
| dewa wishnu _(ENTITAS_KEAGAMAAN)_ | `TIDUR_DI` | atas samudra (dialasi dan dipayungi naga/ular cobra berkepala banyak) | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| gegaleng kepala | `BERARTI` | bantal untuk tidur | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| gegaleng _(SARANA_RITUAL)_ | `TERBUAT_DARI` | uang kepeng (pipis bolong) sebanyak 250 biji | manual_override |
| uang kepeng | `ADALAH` | pipis bolong _(SARANA_RITUAL)_ | manual_override |
| gegaleng _(SARANA_RITUAL)_ | `TERBUAT_DARI` | potongan-potongan dahan kayu dapdap yang dibungkus dengan kain putih | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| gegaleng | `ADALAH` | pengganti bantal kapuk yang telah dipakai pada waktu pabersihan hidup | manual_override |
| gegaleng | `DIKENAL_SEBAGAI` | galeng pengerekan | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| atma _(KONSEP_FILOSOFIS)_ | `LEPAS_BEBAS_DARI` | badan | manual_override |
...
| anget-angetan | `BERMAKNA` | agar orang yang meninggal dapat numitis lagi dan terhindar dari penyakit, serta memiliki budi pekerti dan pikiran yang baik | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| penggunaan wewangian | `BERTUJUAN_AGAR` | orang yang numitis memperoleh pujian keharuman dalam tingkah lakunya | manual_override |
| numitis _(KONSEP_FILOSOFIS)_ | `MENYEBABKAN` | badan menjadi harum | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| kwangen jeriji | `DITARUH_DI` | telapak tangan | manual_override |
| kwangen jeriji | `DITARUH_DI` | telapak kaki | manual_override |
...
| kojong (kawangen jeriji) | `BERISI` | lima buah gulungan base (daun sirih) | manual_override |
| gulungan daun sirih | `DIIKAT_DENGAN` | benang putih | manual_override |
| gulungan sirih | `DIMASUKKAN_KE` | lubang uang kepeng _(SARANA_RITUAL)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| kesuna (bawang putih) | `BERMAKNA` | agar orang yang numitis kembali memiliki kuku-kuku yang indah dan putih bersih | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| uang kepeng asli _(SARANA_RITUAL)_ | `MENGANDUNG` | lima unsur logam | manual_override |
| perak | `BERWARNA` | putih | manual_override |
| perak | `BERADA_DI` | timur | manual_override |
| perak | `BERDEWA` | dewa iswara _(ENTITAS_KEAGAMAAN)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| tembaga | `BERWARNA` | merah | manual_override |
| tembaga | `BERADA_DI` | selatan _(Place)_ | manual_override |
| tembaga | `BERDEWA` | dewa brahma _(ENTITAS_KEAGAMAAN)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| emas | `BERWARNA` | kuning | manual_override |
| emas | `BERADA_DI` | barat | manual_override |
| emas | `BERDEWA` | dewa mahadewa _(ENTITAS_KEAGAMAAN)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| besi | `BERWARNA` | hitam | manual_override |
| besi | `BERADA_DI` | utara | manual_override |
| besi | `BERDEWA` | dewa wishnu _(ENTITAS_KEAGAMAAN)_ | manual_override |
| logam campuran | `BERWARNA` | manca warna | manual_override |
| logam campuran | `BERADA_DI` | tengah | manual_override |
| logam campuran | `BERDEWA` | dewa siwa _(ENTITAS_KEAGAMAAN)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| jarum (jaum) | `DITARUH_DI` | lengan jenazah _(ISTILAH_UMUM_RITUAL)_ | manual_override |
| besi paku | `DITARUH_DI` | lengan jenazah _(ISTILAH_UMUM_RITUAL)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| tirtha _(TIRTHA_SUCI)_ | `DIPERCIKKAN_PADA` | seluruh badan hingga ke kaki jenazah | manual_override |
| priuk (tempat tirtha pangringkes) | `DIPECAHKAN` | setelah tirtha dipercikkan _(TIRTHA_SUCI)_ | manual_override |
| priuk (yang pecah) | `DIBUANG_DI` | kolong bawah pepaga/asagan _(SARANA_RITUAL)_ | manual_override |
...
| jenazah (setelah dibungkus tiga lapis) | `DIIKAT_DENGAN` | tali benang tukelan _(SARANA_RITUAL)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| kain (penutup jenazah) | `DIISI_DENGAN` | rurub sinom sebanyak lima buah _(SARANA_RITUAL)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| rurub sinom _(SARANA_RITUAL)_ | `ADALAH` | hiasan | manual_override |
| hiasan | `TERBUAT_DARI` | blangsah _(SARANA_RITUAL)_ | manual_override |
| hiasan | `TERBUAT_DARI` | daun kelapa muda (busung) | manual_override |
| blangsah _(SARANA_RITUAL)_ | `ADALAH` | bunga pinang yang belum mekar | manual_override |
| rurub sinom _(SARANA_RITUAL)_ | `BERUKURAN_PANJANG` | kira-kira 40 sampai 45 sentimeter | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| rurub sinom | `DIAMBIL_DARI` | gulungan jenazah (sebelum dimasukkan ke peti) | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| jenazah _(ISTILAH_UMUM_RITUAL)_ | `DIMASUKKAN_KE_DALAM` | peti | manual_override |
| rurub sinom tadi _(SARANA_RITUAL)_ | `DILETAKKAN_DI` | atas peti | manual_override |
| rurub sinom tadi _(SARANA_RITUAL)_ | `DILETAKKAN_MELINTANG_DI` | kepala, leher, perut, paha dan kaki | manual_override |
...
| bilahan-bilahan bambu (ante) | `DIKENAL_SEBAGAI` | galar _(SARANA_RITUAL)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| bale-bale/dipan | `DIPAKAI_UNTUK` | warung atau dapur | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| galar (dengan ketekan guling) | `DIGUNAKAN_DENGAN_HARAPAN` | membuat ngantuk dan tidur nyenyak | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| bale-bale | `DILETAKKAN_DI` | pura atau merajan _(BANGUNAN_RITUAL)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| jumlah galar | `CONTOH` | 5, 10, 15, 20, 25, 30, dan seterusnya (kelipatan 5) | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| upacara mesulub _(RITUAL_KEMATIAN)_ | `ADALAH` | kepercayaan setempat yang telah diwarisi turun temurun sejak jaman dulu di daerah atau desa setempat | manual_override |
| kepercayaan setempat | `ADALAH` | kepercayaan lokal | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| upacara mesulub _(RITUAL_KEMATIAN)_ | `ADALAH` | konsep satya (kesetiaan) | manual_override |
...
| masyarakat setempat | `MELAKUKAN` | upacara mesaji (atau memunjung), ketika jenazah masih di atas pepaga/asagan | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| jenazah _(ISTILAH_UMUM_RITUAL)_ | `DIBAWA_KE` | setra untuk segera dikuburkan (bukan diaben) | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| jenazah _(ISTILAH_UMUM_RITUAL)_ | `MENJALANI` | rangkaian upacara lain sebelum dibawa ke setra (jika diaben) | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| jempol jari tangan (kedua ibu jari) | `DIIKAT_DENGAN` | tali benang tukelan _(SARANA_RITUAL)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| tirtha _(TIRTHA_SUCI)_ | `DIPAKAI_UNTUK` | ngalukat | manual_override |
| ngalukat | `ADALAH` | pembersihan tingkat awal | manual_override |
| tirtha _(TIRTHA_SUCI)_ | `DIPAKAI_UNTUK` | banten _(SARANA_RITUAL)_ | manual_override |
| tirtha _(TIRTHA_SUCI)_ | `DIPAKAI_UNTUK` | adegan (SARANA_RITUAL) _(SARANA_RITUAL)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| tirtha pabersihan _(TIRTHA_SUCI)_ | `DIBUAT_OLEH` | ida sang sulinggih _(ENTITAS_KEAGAMAAN)_ | manual_override |
| tirtha pabersihan _(TIRTHA_SUCI)_ | `TIDAK_MEMAKAI` | samsam (tidak seperti tirtha panglukatan) _(TIRTHA_SUCI)_ | manual_override |
| tirtha pabersihan (periuknya) | `TANPA` | kalung benang dengan uang kepeng _(SARANA_RITUAL)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| tirtha ening _(TIRTHA_SUCI)_ | `BERFUNGSI_SEBAGAI` | symbol pikiran dan perasaan sang yajamana ( orang yang punya upacara ) , sehingga roh atau atman yang di upacarai tidak mengalami kegoncangan , sehingga dapat mencapai alam sorga dengan tenang | dependency_rule |
...
| subject | relation | object | source |
|---|---|---|---|
| tirtha penembak _(TIRTHA_SUCI)_ | `MEMILIKI` | hubungan erat dengan itihasa (Bisma Parwa, bagian dari Mahabharata) | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| arjuna _(ENTITAS_KEAGAMAAN)_ | `MEMANAH` | tanah (di samping rsi bisma) | manual_override |
| air (dari tanah yang dipanah arjuna) | `MENGENAI` | bibir rsi bisma | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| tirtha _(TIRTHA_SUCI)_ | `DIBAWA_KE` | setra untuk dipergunakan pada waktu pembakaran | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| sarana dan prasarana (upacara pemujaan) | `BERUPA` | pras, ajuman, daksina, suci, rayunan, dan kadang-kadang pajegan | manual_override |
| tirtha _(TIRTHA_SUCI)_ | `DIMOHONKAN_OLEH` | pemangku kawitan setempat _(ENTITAS_KEAGAMAAN)_ | manual_override |
...
|---|---|---|---|
| sarana dan prasarana (upacara pemujaan) | `BERUPA` | pras, ajuman, daksina, suci, rayunan, dan kadang-kadang pajegan | manual_override |
| tirtha _(TIRTHA_SUCI)_ | `DIMOHONKAN_OLEH` | pemangku kahyangan tiga setempat _(BANGUNAN_RITUAL)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| tirtha _(TIRTHA_SUCI)_ | `BERFUNGSI_SEBAGAI` | sarana pengembalian roh (atma) kepada sang pencipta | manual_override |
| pura kahyangan tiga _(BANGUNAN_RITUAL)_ | `ADALAH` | tempat pemujaan sang pencipta | manual_override |
| pura kahyangan tiga _(BANGUNAN_RITUAL)_ | `BERFUNGSI_SEBAGAI` | utpeti _(KONSEP_FILOSOFIS)_ | manual_override |
| pura kahyangan tiga _(BANGUNAN_RITUAL)_ | `BERFUNGSI_SEBAGAI` | sthiti | manual_override |
| pura kahyangan tiga _(BANGUNAN_RITUAL)_ | `BERFUNGSI_SEBAGAI` | pralina _(TAHAPAN_UPACARA)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| tirtha pangentas _(TIRTHA_SUCI)_ | `DIBUAT_DI` | gria ida sang sulinggih (kediaman pendeta) atau di rumah | manual_override |
| tirtha pangentas _(TIRTHA_SUCI)_ | `DIBUAT_SAAT` | upacara pengaskaran (bertepatan dengan puncak upacara pengabenan) | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| tirtha pangentas _(TIRTHA_SUCI)_ | `MEMILIKI` | fungsi utama sebagai sarana untuk "ngentas": memberikan jalan dan membersihkan noda-noda roh atau atma orang yang meninggal, agar dapat menuju ke alam kedewataan | manual_override |
| upacara pengabenan _(RITUAL_KEMATIAN)_ | `ADALAH` | upacara penyucian roh atau atman (purusa) orang yang telah meninggal, agar terlepas dari ikatan panca mahabhuta, sehingga dapat menuju alam dewa (swah loka) | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| tirtha pangentas _(TIRTHA_SUCI)_ | `ADALAH` | sesuatu yang memiliki arti erat dengan upacara pitra yadnya | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| tirtha pangentas _(TIRTHA_SUCI)_ | `ADALAH` | tirtha yang diharapkan dan diyakini sebagai alat atau sarana sangat penting bagi umat hindu, khususnya dalam hubungannya untuk dapat melepaskan roh para leluhur dari ikatan-ikatan keduniawian, sehingga para leluhur dapat bebas dan bisa meningkat menuju alam bhwah loka | manual_override |
...
| upacara mapulang lingga | `BERARTI` | "ngelinggihang lingga" (dalam diri) _(TAHAPAN_UPACARA)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| atma lingga _(KONSEP_FILOSOFIS)_ | `MEWUJUDKAN` | sanghyang ongkara dan tri aksara dalam diri (yang berstana dalam bathin) | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| tirtha pangentas _(TIRTHA_SUCI)_ | `ADALAH` | tirtha gangga yang diturunkan atau dibuat oleh pendeta/sang sulinggih | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| badan | `BERSINAR_BAGAIKAN` | matahari | manual_override |
| abu abu kekototan (kekotoran) _(SARANA_RITUAL)_ | `MUSNAH` | melalui ritual amrethi karana | manual_override |
| amrethi karana | `DILAKUKAN_DENGAN` | mengucurkan tirtha amertha dalam diri _(KONSEP_FILOSOFIS)_ | manual_override |
...
| pramakusa _(SARANA_RITUAL)_ | `DIMANTRAI` | sebelum dimasukkan ke dalam priuk | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| padang lepas _(SARANA_RITUAL)_ | `DIMASUKKAN_KE_DALAM` | periuk | manual_override |
| kalpika _(SARANA_RITUAL)_ | `DIMASUKKAN_KE_DALAM` | periuk | manual_override |
| jijih (biji padi) | `DIMASUKKAN_KE_DALAM` | periuk | manual_override |
| pripih emas | `DIMASUKKAN_KE_DALAM` | periuk | manual_override |
| recadana | `DIMASUKKAN_KE_DALAM` | periuk | manual_override |
| ulantaga | `DIMASUKKAN_KE_DALAM` | periuk | manual_override |
| sarana-sarana tersebut | `DIMANTRAI_OLEH` | ida sang sulinggih (sebelum dimasukkan) _(ENTITAS_KEAGAMAAN)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| ganda _(KONSEP_FILOSOFIS)_ | `BERASAL_DARI` | pretiwi _(KONSEP_FILOSOFIS)_ | manual_override |
| ganda _(KONSEP_FILOSOFIS)_ | `KEMBALI_KE` | pretiwi _(KONSEP_FILOSOFIS)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| rasa _(KONSEP_FILOSOFIS)_ | `BERASAL_DARI` | apah _(KONSEP_FILOSOFIS)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| rupa _(KONSEP_FILOSOFIS)_ | `BERASAL_DARI` | teja _(KONSEP_FILOSOFIS)_ | manual_override |
| rupa _(KONSEP_FILOSOFIS)_ | `KEMBALI_KE` | teja _(KONSEP_FILOSOFIS)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| ambekan _(KONSEP_FILOSOFIS)_ | `BERASAL_DARI` | bayu _(KONSEP_FILOSOFIS)_ | manual_override |
| ambekan _(KONSEP_FILOSOFIS)_ | `KEMBALI_KE` | bayu _(KONSEP_FILOSOFIS)_ | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| sabda _(KONSEP_FILOSOFIS)_ | `BERASAL_DARI` | akasa _(KONSEP_FILOSOFIS)_ | manual_override |
| sabda _(KONSEP_FILOSOFIS)_ | `KEMBALI_KE` | akasa _(KONSEP_FILOSOFIS)_ | manual_override |
...
| pengabenan (tanpa tirtha pangentas) | `DIANGGAP` | belum dilaksanakan | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| tirtha pangentas _(TIRTHA_SUCI)_ | `ADALAH` | alat sangaskara kepada roh atau atman orang yang telah meninggal dunia | dependency_rule |
| tirtha pangentas _(TIRTHA_SUCI)_ | `ADALAH` | penyucian | dependency_rule |
...
| subject | relation | object | source |
|---|---|---|---|
| tirtha pangentas _(TIRTHA_SUCI)_ | `ADALAH` | lambang penunjuk jalan bagi roh atau atman untuk kembali ke asalnya (brahman/alam swah loka) sebagai tujuan terakhir | manual_override |
...
| subject | relation | object | source |
|---|---|---|---|
| tirtha pangentas _(TIRTHA_SUCI)_ | `BERFUNGSI_SEBAGAI` | pelebur unsur karma wasana _(KONSEP_FILOSOFIS)_ | dependency_rule |
